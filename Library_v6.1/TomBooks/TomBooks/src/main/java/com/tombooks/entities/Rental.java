...
@NamedQueries({
    ...
    @NamedQuery(name = "Rental.findByDataZwrotu", query = "SELECT r FROM Rental r WHERE r.dataZwrotu = :dataZwrotu")})
public class Rental implements Serializable {
    ...
    public Rental(Long id, String status) {
        this.id = id;
        this.status = status;
    }
    ...
    public String toString() {
        return "com.tombooks.entities.Rental[ id=" + id + " ]";
    }
    
    public Date getCreatedAtPlusOneMonth() {
    if (createdAt == null) {
        return null;
    }
    ...
    public boolean isActive() {
        return dataZwrotu != null && dataZwrotu.after(new Date());
    }

    public boolean isReturned() {
        return dataZwrotu == null || dataZwrotu.before(new Date());
    }
}
